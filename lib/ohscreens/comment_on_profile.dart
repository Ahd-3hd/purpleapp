...
class CommentOnProfile extends StatefulWidget {
  final profileid;
  CommentOnProfile({this.profileid});
  @override
  _CommentOnProfileState createState() => _CommentOnProfileState();
}

class _CommentOnProfileState extends State<CommentOnProfile> {
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: () async {
                        await DatabaseSerivce()
                            .commentOnProfile(
                                widget.profileid, commentText, user.uid)
